			...
			->setSection()
				...
				->addSetting()
					...
					->setControl()
						...
						->setType('color')
				->addSetting()
					->setName('site_third_color')
					->setType('theme_mod')
					->setDefault( '#125667' )
					->setSanitize('wp_filter_nohtml_kses')
					->setControl()
						->setLabel(esc_attr__('Site Third Color' , TBM_TEXTDOMAIN))
						->setDescription(esc_attr__('Please, select the site third color here' , TBM_TEXTDOMAIN))
						->setType('color')
				->addSetting()
